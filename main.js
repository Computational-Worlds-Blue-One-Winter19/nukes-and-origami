...
class Plane extends Entity {
  ...
  update() {
    if (this.moving === true
      && (this.game.arrowLeftReleased === true || this.game.arrowRightReleased === true
      || this.game.arrowUpReleased === true || this.game.arrowDownReleased === true)) {
      this.moving = false;
    }
    ...
    if (this.game.arrowLeftPressed) {
      // if (this.isIdle === true) {
      console.log('Applying the left sprite');
      console.log('isIdle true');
      this.sprite = this.left; // Use the moving left sprite
      this.isIdle = false;
      // }
      this.moving = true;
      this.x -= 1 * this.speed * this.game.clockTick;
