...
AM.queueDownload('bat.png');
AM.queueDownload('bird.png');
AM.queueDownload('crane.png');
AM.queueDownload('dove.png');
AM.queueDownload('eagle.png');
AM.queueDownload('goose.png');
AM.queueDownload('hummer.png');
AM.queueDownload('owl.png');
AM.queueDownload('pigeon.png');
AM.queueDownload('swallow.png');
AM.queueDownload('mini-crane-sheet.png');
AM.queueDownload('plane-small.png');
AM.queueDownload('purple-plane-small.png');
AM.queueDownload('notebook.png');
AM.queueDownload('bullet.png');
AM.queueDownload('nuke_single.png');
AM.queueDownload('rainbow_ball.png');
AM.queueDownload('shield-icon.png');
AM.queueDownload('shield.png');
AM.queueDownload('rapid-bullet.png');
AM.queueDownload('paper_ball.png');
AM.queueDownload('clouds.png');
AM.queueDownload('7_shoot_sheet.png');
AM.queueDownload('glass_ball.png');
AM.queueDownload('laser_red.png');
AM.queueDownload('cut_laser.png');
AM.queueDownload('heart.png');
AM.queueDownload('reverse.png');
AM.queueDownload('fire-rate.png');
AM.queueDownload('space1024x3072.png');
AM.queueDownload('light_blue_plane.png');
AM.queueDownload('verticalscrollingbeach.png');
AM.queueDownload('verticalscrollingcemetary.png');
AM.queueDownload('verticalscrollingtrees.png');
AM.queueDownload('verticalscrollingdesert.png');
AM.queueDownload('seamless_pattern.png');
AM.queueDownload('missile.png');
AM.queueDownload('gunup.png');
AM.queueDownload('chaingun.png');
AM.queueDownload('explosion-sheet.png');
AM.queueDownload('white_background.jpg');
AM.queueDownload('rapid-bullet-horizontal.png');
